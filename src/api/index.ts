...
export async function getCurrentPrice(){
    const response = await fetch(`http://37.60.236.70:5000/quote/getCurrentPrice`, {
        method: 'POST',
        headers: {
...
export async function createGameState(userPublicAddress: string){
    const response = await fetch(`http://37.60.236.70:5000/database/createGameState`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': encryptResponse("dev-f34bb00a492a1a506bfsfefeojfqo51dsdzd023cd4e4d9d4dfa140621d35084e15319a")
...
export async function getGameState(userPublicAddress: string){
    const response = await fetch(`http://37.60.236.70:5000/database/getDatabaseData`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': encryptResponse("dev-f34bb00a492a1a506bfsfefeojfqo51dsdzd023cd4e4d9d4dfa140621d35084e15319a")
...
export async function updateGameState(userPublicAddress: string, gameState: GameState){
    ...
    const response = await fetch(`http://37.60.236.70:5000/database/updateDatabaseData`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': encryptResponse("dev-f34bb00a492a1a506bfsfefeojfqo51dsdzd023cd4e4d9d4dfa140621d35084e15319a")
...
export async function interactWithContract(){
    const response = await fetch(`http://37.60.236.70:5000/contract/interactWithContract`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'x-api-key': encryptResponse("dev-f34bb00a492a1a506bfsfefeojfqo51dsdzd023cd4e4d9d4dfa140621d35084e15319a")
