...
export const TECHNOLOGIES: Technology[] = [
   ...
   {
        name: "Permafrost Engineering",
        cost: 20000,
        effect: 30, // +30% research speed
        category: "Production",
        description: "Improves passive ice collection efficiency",
        researchTime: 600,
        prerequisites: ["Advanced Mining Techniques"]
   },
   {
        name: "Best Sellers",
        cost: 6000,
        effect: 100, // Vends 2 fois plus vite
        category: "Market",
        description: "Sell ice 2 times faster",
        researchTime: 200,
        prerequisites: ["Market Analysis"]
    }
];
